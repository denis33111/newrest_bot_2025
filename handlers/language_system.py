...
REGISTRATION_QUESTIONS = {
    'en': {
        ...
        'try_again_later': 'Please try again later. The system is temporarily busy.',
        ...
        'already_checked_in_clear': "Today's time has already been recorded. You can check in again tomorrow.",
    ...
    'gr': {
        ...
        'check_in_failed': 'Εγγραφή Απέτυχε',
        'try_again_later': 'Παρακαλώ δοκιμάστε ξανά αργότερα. Το σύστημα είναι προσωρινά απασχολημένο.',
        ...
        'already_checked_in_clear': 'Η ώρα σήμερα έχει ήδη καταγραφεί. Μπορείτε να κάνετε εγγραφή ξανά αύριο.',
